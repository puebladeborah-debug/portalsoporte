...
const BLACK_ACCESS: Subseccion[] = [
  {
    ...
    items: [
      { nombre: 'Black Access',            precio: '$36,997 MXN', url: 'https://www.synergyforeducation.com/offers/bEcVEwrw' },
      { nombre: 'Pase Doble Black Access', precio: '$55,497 MXN', url: 'https://www.synergyforeducation.com/offers/SkQRGRbe' },
      { nombre: 'Black Access a meses',    precio: '$42,916 MXN', url: 'https://buy.stripe.com/eVq28s5wo4k28fgetg7Rk1e' },
      { nombre: 'Pase Doble a meses',      precio: '$64,376 MXN', url: 'https://buy.stripe.com/7sY00k9MEg2K3Z01Gu7Rk1f' },
    ],
  },
  {
    titulo: 'Apartados México',
    items: [
      { nombre: 'Apartado Black Access',            precio: '$9,999 MXN',  url: 'https://www.synergyforeducation.com/offers/QW4bS32r' },
      { nombre: 'Apartado Pase Doble',              precio: '$15,999 MXN', url: 'https://www.synergyforeducation.com/offers/nMxUDpQp' },
      { nombre: 'Apartado Black Access a meses',    precio: '$11,599 MXN', url: 'https://buy.stripe.com/9B6cN68IAaIq8fgcl87Rk1g' },
      { nombre: 'Apartado Pase Doble a meses',      precio: '$18,558 MXN', url: 'https://buy.stripe.com/7sYeVebUMdUCgLMgBo7Rk1h' },
    ],
  },
  {
    titulo: 'General Access · México',
    items: [
      { nombre: 'General Access',         precio: '$5,997 MXN', url: 'https://www.synergyforeducation.com/offers/sHf5tG7W' },
      { nombre: 'General Access a meses', precio: '$6,837 MXN', url: 'https://buy.stripe.com/5kQcN69ME7we6783OC7Rk1i' },
      { nombre: 'General Access',         precio: '$3,997 MXN', url: 'https://www.synergyforeducation.com/offers/Q4LogqdV' },
      { nombre: 'General Access a meses', precio: '$4,556 MXN', url: 'https://buy.stripe.com/dRmcN65wo6sa5345WK7Rk1j' },
      { nombre: 'General Access',         precio: '$7,997 MXN', url: 'https://www.synergyforeducation.com/offers/8dLZZrus' },
      { nombre: 'General Access a meses', precio: '$9,116 MXN', url: 'https://buy.stripe.com/eVqdRa2kc4k20MOad07Rk1k' },
    ],
  },
  {
    titulo: 'VIP Access · México',
    items: [
      { nombre: 'VIP Access',         precio: '$5,997 MXN', url: 'https://www.synergyforeducation.com/offers/vFAPaM3B' },
      { nombre: 'VIP Access a meses', precio: '$6,836 MXN', url: 'https://buy.stripe.com/6oU8wQ6As2bU7bc0Cq7Rk1l' },
    ],
  },
  {
    titulo: 'Centurion · México',
    items: [
      { nombre: 'Centurion',                 precio: '$90,000 MXN',  url: 'https://www.synergyforeducation.com/offers/VoBDAjgW' },
      { nombre: 'Centurion a meses',         precio: '$104,000 MXN', url: 'https://buy.stripe.com/bJedRacYQ6sa9jk0Cq7Rk1m' },
      { nombre: 'Centurion',                 precio: '$144,000 MXN', url: 'https://www.synergyforeducation.com/offers/wfLpTKeQ' },
      { nombre: 'Centurion a meses',         precio: '$167,000 MXN', url: 'https://buy.stripe.com/14AbJ2bUM3fY8fg84S7Rk1n' },
      { nombre: 'Abono Centurion',           precio: '$55,997 MXN',  url: 'https://www.synergyforeducation.com/offers/LJtVB2Dm' },
      { nombre: 'Abono Centurion a meses',   precio: '$64,997 MXN',  url: 'https://buy.stripe.com/dRm5kEcYQ4k2cvwgBo7Rk1o' },
      { nombre: 'Abono Centurion',           precio: '$91,997 MXN',  url: 'https://www.synergyforeducation.com/offers/tPTU7xdQ' },
      { nombre: 'Centurion Doble a meses',   precio: '$106,716 MXN', url: 'https://buy.stripe.com/8x228s2kcaIqeDE5WK7Rk1p' },
    ],
  },
  {
    titulo: 'USA · Black Access',
    items: [
      { nombre: 'Black Access',              precio: '$1,997 USD', url: 'https://www.synergyforeducation.com/offers/ttDoMbie' },
      { nombre: 'Pase Doble Black Access',   precio: '$2,997 USD', url: 'https://www.synergyforeducation.com/offers/5Frzbkfk' },
      { nombre: 'Apartado Black Access',     precio: '$499 USD',   url: 'https://www.synergyforeducation.com/offers/rE7ZWZea' },
      { nombre: 'Apartado Pase Doble',       precio: '$799 USD',   url: 'https://www.synergyforeducation.com/offers/BKZNFA2P' },
      { nombre: 'General Access',            precio: '$297 USD',   url: 'https://www.synergyforeducation.com/offers/oyzBqqCj' },
      { nombre: 'General Access',            precio: '$197 USD',   url: 'https://www.synergyforeducation.com/offers/uNJqZNRV' },
      { nombre: 'VIP Access',                precio: '$397 USD',   url: 'https://www.synergyforeducation.com/offers/cipSNDwV' },
      { nombre: 'VIP Access',                precio: '$297 USD',   url: 'https://www.synergyforeducation.com/offers/4x5wRKH4' },
      { nombre: 'Centurion',                 precio: '$4,997 USD', url: 'https://www.synergyforeducation.com/offers/rdpUDkve' },
      { nombre: 'Centurion Doble',           precio: '$7,997 USD', url: 'https://www.synergyforeducation.com/offers/LA9tfSqF' },
      { nombre: 'Abono Centurion',           precio: '$3,000 USD', url: 'https://www.synergyforeducation.com/offers/2muzVugM' },
      { nombre: 'Abono Centurion Doble',     precio: '$5,000 USD', url: 'https://www.synergyforeducation.com/offers/ry6JizC2' },
    ],
  },
  {
    titulo: 'LATAM',
    items: [
      ...
      { nombre: 'Pase Doble Black Access', precio: 'Ver link', url: 'https://pay.hotmart.com/O106162861G?off=y0uogpak' },
    ],
  },
]
